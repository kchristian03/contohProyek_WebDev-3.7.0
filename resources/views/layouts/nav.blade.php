        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="flex-shrink-0 flex items-center">
                    <img class="block lg:hidden h-8 w-auto" src="https://dieng.blob.core.windows.net/webmaster/2021/09/LOGO-UC-PANJANG-FIX-SEP-2021-01.png" alt="Workflow">
                    <img class="hidden lg:block h-8 w-auto" src="https://dieng.blob.core.windows.net/webmaster/2021/09/LOGO-UC-PANJANG-FIX-SEP-2021-01.png" alt="Workflow">
                </div>
                ...
                <div x-data="Components.menu({ open: false })" x-init="init()" @keydown.escape.stop="open = false; focusButton()" @click.away="onClickAway($event)" class="ml-3 relative">
                    <div>
                        <button type="button" class="bg-white rounded-full flex text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" id="user-menu-button" x-ref="button" @click="onButtonClick()" @keyup.space.prevent="onButtonEnter()" @keydown.enter.prevent="onButtonEnter()" aria-expanded="false" aria-haspopup="true" x-bind:aria-expanded="open.toString()" @keydown.arrow-up.prevent="onArrowUp()" @keydown.arrow-down.prevent="onArrowDown()">
                            ...
                            <img class="h-8 w-8 rounded-full" src="https://dieng.blob.core.windows.net/webmaster/2021/09/LOGO-UC-FIX-SEP-2021-01.png" alt="">
                        </button>
                    </div>
        ...
        <div class="pt-4 pb-3 border-t border-gray-200">
            <div class="flex items-center px-4">
                <div class="flex-shrink-0">
                    <img class="h-10 w-10 rounded-full" src="https://dieng.blob.core.windows.net/webmaster/2021/09/LOGO-UC-FIX-SEP-2021-01.png" alt="">
                </div>
                <div class="ml-3">
                    <div class="text-base font-medium text-gray-800">Kevin Christian</div>
                    <div class="text-sm font-medium text-gray-500">kchristian@student.ciputra.ac.id</div>
                </div>
